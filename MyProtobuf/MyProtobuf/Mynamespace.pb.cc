...
namespace Mynamespace {
	...
	void protobuf_AssignDesc_Mynamespace_2eproto() {
		...
		static const int BlobProto_offsets_[8] = {
			...
			GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BlobProto, blobs_),
		};
	...
	void protobuf_AddDesc_Mynamespace_2eproto() {
		...
		::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
			...
			"\004blob\030\007 \001(\0132\021.Mynamespace.Blob\022 \n\005blobs\030"
			"\010 \003(\0132\021.Mynamespace.Blob", 264);
...
#undef DO_
  ...
  return total_size;
	...
	const int BlobProto::kBlobsFieldNumber;
#endif  // !_MSC_VER
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
		...
		for (;;) {
			...
			case 7: {
				...
				if (input->ExpectTag(66)) goto parse_blobs;
				break;
			}
